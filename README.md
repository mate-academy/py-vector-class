...
vector.x_coordinate == -2.34
vector.y_coordinate == 8.0
```
...
vector3.x_coordinate == 1
vector3.y_coordinate == 7
```
- `__sub__`
...
isinstance(vector3, Vector) is True
vector3.x_coordinate == 3
vector3.y_coordinate == 1
```
- `__mul__`
...
vector.x_coordinate == 5.5
vector.y_coordinate == 3.4
```
...
vector2.x_coordinate == 0.96
vector2.y_coordinate == -0.29
...
vector2.x_coordinate == 17.68
vector2.y_coordinate == 28.99
```
