...
vector.first_cord == -2.34
vector.second_cord == 8.0
```
...
vector3.first_cord == 1
vector3.second_cord == 7
```
- `__sub__`
...
isinstance(vector3, Vector) is True
vector3.first_cord == 3
vector3.second_cord == 1
```
- `__mul__`
...
vector.first_cord == 5.5
vector.second_cord == 3.4
```
...
vector2.first_cord == 0.96
vector2.second_cord == -0.29
...
vector2.first_cord == 17.68
vector2.second_cord == 28.99
```
