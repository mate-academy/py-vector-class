...
vector.vectors_x == -2.34
vector.vectors_y == 8.0
```
...
vector.vectors_x == 5.5
vector.vectors_y == 3.4
```
...
vector2.vectors_x == 0.96
vector2.vectors_y == -0.29
...
vector2.vectors_x == 17.68
vector2.vectors_y == 28.99
```
