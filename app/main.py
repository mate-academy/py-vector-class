...
class Vector:
    ...
    def __init__(self, x: int | float, coord_y: int | float) -> None:
        self.coord_x = round(x, 2)
    ...
    def get_length(self) -> int | float:
        vector_length = math.sqrt((self.coord_x * self.coord_x) + (self.coord_y * self.coord_y))
        return vector_length

    def get_normalized(self) -> Vector:
        vector_lenght = self.get_length()
        return Vector(self.coord_x / vector_lenght, self.coord_y / vector_lenght)
    ...
    def angle_between(self, other: Vector) -> int:
        if isinstance(other, Vector):
            ...
            if lengths_product == 0:
                ...
                cos_theta = round(math.degrees(math.acos(dot_product / lengths_product)))
            return cos_theta

    def get_angle(self) -> int | float:
        if self.get_length() == 0:
            return 0
        cos_theta = round(math.degrees(math.acos(self.coord_y / self.get_length())))
        return cos_theta
    ...
    def rotate(self, degrees: int) -> Vector:
        ...
        new_x = (self.coord_x * math.cos(radians_degres)) - (self.coord_y * math.sin(radians_degres))
        new_y = (self.coord_x * math.sin(radians_degres)) + (self.coord_y * math.cos(radians_degres))
