...
class Vector:
    ...
    def __add__(self, other: Vector) -> Vector:
        return Vector(x_value=self.x + other.x, y_value=self.y + other.y)
    ...
    def __mul__(self, other: int | float | Vector) -> Vector | int | float:
        ...
        return Vector(x_value=self.x * other, y_value=self.y * other)
    ...
    def get_angle(self) -> int:
        y_axis = Vector(x_value=0, y_value=1)
    ...
    def rotate(self, degrees: int) -> Vector:
        ...
        return Vector(x_value=x_value, y_value=y_value)
