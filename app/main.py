...
class Vector:
    ...
    def rotate(self, degrees: int) -> Vector:
        cos_x = self.x / self.get_length()
        cos_y = self.y / self.get_length()
        x = (math.cos((math.acos(cos_x) + math.radians(degrees)))) * self.get_length()
        y = (math.cos(math.acos(cos_y) - math.radians(degrees))) * self.get_length()
        return Vector(x, y)