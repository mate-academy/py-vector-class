...
class Vector:
    ...
    @classmethod
    def create_vector_by_two_points(cls, start_point: tuple[float | int],
    ...
    def angle_between(self, vector: Vector) -> float:
        length_prod = (self.get_length() * vector.get_length())
        return round(math.degrees(math.acos((self * vector) / length_prod)))
