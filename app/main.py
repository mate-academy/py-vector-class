...
class Vector:
    ...
    def __mul__(self,
                other: Union["Vector", float, int]) -> Union["Vector", float]:
    ...
    def rotate(self, degrees: int) -> "Vector":
        ...
        return Vector(self.x * math.cos(degrees_rad)
                      - self.y * math.sin(degrees_rad),
                      self.x * math.sin(degrees_rad)
                      + self.y * math.cos(degrees_rad))
