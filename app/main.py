...
class Vector:
    ...
    def rotate(self, degrees: int) -> Vector:
        return Vector(
            x=math.cos(math.radians(degrees)) * self.x - math.sin(math.radians(degrees)) * self.y,
            y=math.cos(math.radians(degrees)) * self.y + math.sin(math.radians(degrees)) * self.x
        )
